...
void LoadTextures()
{
	...
	t_rust = generateTextures("Texturas/rust.png", 0);
	t_rust_brillo = generateTextures("Texturas/rust_brillo.png", 0);
	...
	glBindTexture(GL_TEXTURE_2D, t_rust);
	glActiveTexture(GL_TEXTURE10);
	glBindTexture(GL_TEXTURE_2D, t_rust_brillo);
}
...
void display(void)
{
	...
	lightingShader.setInt("material_diffuse", t_rust);
	lightingShader.setInt("material_specular", t_rust_brillo);
	glDrawArrays(GL_QUADS, 0, 8);

	lightingShader.setInt("material_diffuse", t_rust);
	lightingShader.setInt("material_specular", 0);
	...
	lightingShader.setInt("material_diffuse", 0);
	lightingShader.setInt("material_specular", t_rust_brillo);
